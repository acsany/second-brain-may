...
def create_note(
    ...
    Args:
        title: The note title (also used as the H1 heading).
        base_dir: Directory in which to create the note.
        now: Optional fixed timestamp; defaults to ``datetime.now()``.
        body: Optional body text written verbatim after the header. Newlines
            are preserved.
    """
